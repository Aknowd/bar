<div class="home-content">
    <section class="diaries-container">
        ...
        <div class="diary-box dream-box">
            ...
            <li><button class="ep-btn" data-folder="dream" data-file="ep0002" data-bg="/images/bg_dream2.jpg">EP0002: Regret Letter</button></li>
            <li><button class="ep-btn" data-folder="dream" data-file="ep0003" data-bg="/images/bg_dream3.jpg">EP0003: Shadow Guardian</button></li>
            <li><button class="ep-btn" data-folder="dream" data-file="ep0004" data-bg="/images/bg_dream4.jpg">EP0004: Life Formation</button></li>
            </ul>
        </div>
